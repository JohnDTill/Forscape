...
cd %~dp0
C:\Qt\Tools\CMake_64\bin\cmake.exe -S C:/Users/johnd/Documents/GitHub/Forscape/example/exampleWidgetQt -B ./build -D CMAKE_BUILD_TYPE=Release
...
C:\Qt\Tools\QtInstallerFramework\4.3\bin\binarycreator.exe --offline-only -c config/config.xml -p packages ForscapeInstaller.exe