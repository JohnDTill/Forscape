...
private:
    ...
    ParseNode oneDim(ParseNodeType type) noexcept;
    ParseNode twoDims(ParseNodeType type) noexcept;
    ParseNode length() noexcept;
    ParseNode trig(ParseNodeType type) noexcept;
    ParseNode log() noexcept;
    ParseNode oneArg(ParseNodeType type) noexcept;
    ParseNode twoArgs(ParseNodeType type) noexcept;
    ParseNode big(ParseNodeType type) noexcept;
    ParseNode oneArgConstruct(ParseNodeType type) noexcept;
