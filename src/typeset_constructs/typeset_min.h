#ifndef TYPESET_MIN_H
#define TYPESET_MIN_H
...
class Min final : public Construct { 
private:
    static constexpr std::string_view word = "min";
    double word_offset;
    double child_offset;
...
public:
    ...
    virtual char constructCode() const noexcept override { return MIN; }
    virtual void writePrefix(std::string& out) const noexcept override { out += MIN_STR; }
