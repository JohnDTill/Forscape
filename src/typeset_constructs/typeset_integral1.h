#ifndef TYPESET_INTEGRAL1_H
#define TYPESET_INTEGRAL1_H
...
class Integral1 final : public Construct { 
public:
    Integral1(){
        setupUnaryArg();
    }

    virtual char constructCode() const noexcept override { return INTEGRAL1; }
