#ifndef TYPESET_DOUBLEINTEGRAL1_H
#define TYPESET_DOUBLEINTEGRAL1_H
...
class DoubleIntegral1 final : public Construct { 
public:
    DoubleIntegral1(){
        setupUnaryArg();
    }

    virtual char constructCode() const noexcept override { return DOUBLEINTEGRAL1; }
...
#endif // TYPESET_DOUBLEINTEGRAL1_H
