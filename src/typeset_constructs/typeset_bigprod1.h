#ifndef TYPESET_BIGPROD1_H
#define TYPESET_BIGPROD1_H
...
class BigProd1 final : public Construct { 
public:
    BigProd1(){
        setupUnaryArg();
    }

    virtual char constructCode() const noexcept override { return BIGPROD1; }
