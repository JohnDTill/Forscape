#ifndef TYPESET_DOUBLEINTEGRALCONV1_H
#define TYPESET_DOUBLEINTEGRALCONV1_H
...
class DoubleIntegralConv1 final : public Construct { 
public:
    DoubleIntegralConv1(){
        setupUnaryArg();
    }

    virtual char constructCode() const noexcept override { return DOUBLEINTEGRALCONV1; }
...
#endif // TYPESET_DOUBLEINTEGRALCONV1_H
