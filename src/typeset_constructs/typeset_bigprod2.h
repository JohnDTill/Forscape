#ifndef TYPESET_BIGPROD2_H
#define TYPESET_BIGPROD2_H
...
class BigProd2 final : public Construct { 
public:
    BigProd2(){
        setupBinaryArgs();
    }

    virtual char constructCode() const noexcept override { return BIGPROD2; }
