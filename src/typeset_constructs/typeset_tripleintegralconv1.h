#ifndef TYPESET_TRIPLEINTEGRALCONV1_H
#define TYPESET_TRIPLEINTEGRALCONV1_H
...
class TripleIntegralConv1 final : public Construct { 
public:
    TripleIntegralConv1(){
        setupUnaryArg();
    }

    virtual char constructCode() const noexcept override { return TRIPLEINTEGRALCONV1; }
...
#endif // TYPESET_TRIPLEINTEGRALCONV1_H
