#ifndef TYPESET_BIGINTERSECTION2_H
#define TYPESET_BIGINTERSECTION2_H
...
class BigIntersection2 final : public Construct { 
public:
    BigIntersection2(){
        setupBinaryArgs();
    }

    virtual char constructCode() const noexcept override { return BIGINTERSECTION2; }
...
#endif // TYPESET_BIGINTERSECTION2_H
